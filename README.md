...
Une petite application web autonome pour préparer une liste de courses à partir de références personnelles.
...
Les produits sont enregistrés uniquement dans le stockage local du navigateur. Une illustration générique est utilisée en attendant l’ajout des vraies photos. Aucun serveur ni compte n’est nécessaire.
